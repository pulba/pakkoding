---
title: "Bikin Naskah Konten TikTok"
category: Prompting
order: 116
description: "Tulis skrip video pendek yang bikin orang betah nonton sampai habis."
content:
  - explanation: |
      **Kenapa Skill Ini Krusial?**
      Perhatian audiens di media sosial sangat pendek (attention span < 3 detik). Script video yang dibuat asal-asalan akan langsung di-scroll.
      
      **Formula Prompt Engineering: Bikin Naskah Konten TikTok**
      ...
      **Studi Kasus: Amatir vs Master**
      ❌ **Prompt Jelek (Amatir):**
      _Bikinin script tiktok tentang bahaya begadang._
      (Output AI akan generik, membosankan, dan tidak bisa langsung dipakai).
      
      ✅ **Prompt Master (Prompt Engineering):**
      _Buat script TikTok untuk mahasiswa (Platform & Audiens). Gunakan hook yang menakutkan tentang efek begadang pada otak (Hook). Berikan 3 tips cepat mengatasi insomnia (Retention). Akhiri dengan suruh audiens tag teman mereka yang suka begadang (CTA). Durasi total maksimal 45 detik, gunakan bahasa gaul Jakarta (Constraint)._
      
      **Simulasi Hasil Output AI:**
      Naskah yang dihasilkan memiliki pacing (tempo) yang cepat, pembukaan yang menghentak, dan struktur yang memaksa audiens menonton sampai habis.
      ...
      **🏆 Challenge Praktik**
      Buka artikel blog acak, lalu gunakan formula ini untuk menyuruh AI mengubahnya menjadi naskah TikTok siap rekam.
    code: |
