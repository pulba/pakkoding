---
title: "Menyuruh AI Bikin Gambar Bagus"
category: Prompting
order: 117
description: "Rahasia mendeskripsikan gambar agar AI menghasilkan karya seni keren."
content:
  - explanation: |
      **Kenapa Skill Ini Krusial?**
      AI Image Generator (Midjourney, DALL-E, Stable Diffusion) tidak mengerti bahasa kiasan. Mereka membutuhkan deskripsi teknis dan literal tentang komposisi visual.
      
      **Formula Prompt Engineering: Menyuruh AI Bikin Gambar Bagus**
      ...
      **Studi Kasus: Amatir vs Master**
      ❌ **Prompt Jelek (Amatir):**
      _Gambar kucing lucu minum kopi di kota masa depan._
      (Output AI akan generik, membosankan, dan tidak bisa langsung dipakai).
      
      ✅ **Prompt Master (Prompt Engineering):**
      _A street cat drinking espresso from a tiny cup (Subject & Action), sitting on a neon-lit cyber-cafe balcony in neo-Tokyo (Environment), highly detailed photorealistic illustration (Style), cinematic cyberpunk lighting, neon reflections, 85mm lens, depth of field (Lighting & Camera)._
      
      **Simulasi Hasil Output AI:**
      AI menghasilkan gambar yang memiliki kedalaman (depth), pencahayaan dramatis, dan gaya visual yang konsisten seperti karya seniman profesional.
      ...
      **🏆 Challenge Praktik**
      Gunakan formula ini di Bing Image Creator / DALL-E untuk membuat poster film fiksi ilmiah karanganmu sendiri!
    code: |
